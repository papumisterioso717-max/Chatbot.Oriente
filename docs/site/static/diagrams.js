...
function syncDiagrams() {
  ...
  positionKey="orienta-demo-positions:"+layoutDiagram;
  manualPositions.clear();movingNodes.clear();collapsedNodes.clear();
  try {
    const saved=localStorage.getItem(positionKey) || (layoutDiagram === "diagrama-1" ? localStorage.getItem("orienta-demo-positions") : null);
